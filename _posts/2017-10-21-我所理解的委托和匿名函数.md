...
> 一位聪明的程序员，他可能觉得C++ 中的函数指针使用起来实在太麻烦，他眼红着隔壁的C#程序员无脑的用着语言为他们提供的Delegate，他发誓要在号称无敌的C++语言中也实现这么一个Delegate，造福子孙后代，于是他废寝忘食，终于成功研发了FastDelegate，这东西牛逼得一塌糊涂，不但好用，而且效率出奇的高，甚至超过了一些准库中的实现。一些编译器厂商纷纷向这位程序员讨教实现高效的函数调用的奥秘。[点这里膜拜](https://www.codeproject.com/Articles/7150/Member-Function-Pointers-and-the-Fastest-Possible
